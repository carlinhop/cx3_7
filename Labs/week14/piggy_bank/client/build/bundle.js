...
/***/ function(module, exports, __webpack_require__) {
	...
	window.onload = function () {
	  ReactDOM.render(React.createElement(PiggyBank, { title: 'Beth\'s piggy bank', colour: 'red', owner: 'Beth', deposit: 200 }), document.getElementById('app'));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PiggyBank = React.createClass({
	  ...
	  subtractToSavings: function subtractToSavings() {
	    this.setState({
	      total: this.state.total - 1
	    });
	  },
	  newDeposit: function newDeposit() {
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        "button",
	        { onClick: this.subtractToSavings },
	        "Decrease!"
	      ),
	      React.createElement("input", { onChange: this.newDeposit, id: "new-deposit" })
	    );
	  }
