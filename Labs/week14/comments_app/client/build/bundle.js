...
/***/ function(module, exports, __webpack_require__) {
	...
	var sampleData = [{ id: 1, author: "Craig", text: "Bears shoud know baseball" }, { id: 2, author: "Cohort 7", text: "Same as everyone else" }];
	...
	var CommentForm = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement("input", { type: "text", placeholder: "Enter name...", value: this.state.author, onChange: this.handleAuthorChange }),
	      React.createElement("input", { type: "text", placeholder: "Enter quote...", value: this.state.text, onChange: this.handleTextChange }),
